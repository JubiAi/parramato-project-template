        ...
        bundle: "${devUrl}/${projectId}/dev/js/bundle.js"
            ...
            window.jubiModal={
                ...
                static:{
                    ...
                    images:{"logo":"${devUrl}/images/logo.png","sendIcon":"${devUrl}/images/icon_send.png","sendIconActive":"${devUrl}/images/iconRed_send.png","loaderBotChat":"${devUrl}/images/response-loading.gif","userIcon":"${devUrl}/images/user.png","botIcon":"${devUrl}/images/boticon.png","logoIcon":"${devUrl}/images/logo-icon.png","voiceIcon":"${devUrl}/images/voice.png","closeWebView":"${devUrl}/images/closeWebView.png","attachment":"${devUrl}/images/attachment.png","permissionIcon":"${devUrl}/images/parrot_loader.gif"},
                    text:{
                        closeMessage:'',
            ...
            window.chatPersistence = true;
                ...
                window.leftpanel =  '<div class="leftPage" id="leftpanel"><div class="leftpanelBg"><div class="leftpage_opacity">&nbsp</div></div><div class="leftContent"><div class="logo"><img src="${devUrl}/images/logo.png" class="img-fluid" ></div><h2>Ask me anything.</h2></div></div>';   
                ...
                '<section class="pm-sec_scroll2 pm-sec_openview" id="pm-mainSec">' + 
                    ...
                    '<section id="pm-heading" class="pm-sec_newHeader">'+
                        '<div class="pm-titleheader" >'+
                            '<h3>'+
                                '<img src="${devUrl}/images/logo-icon.png" class="img-responsive"><span class="pm-headOnline" >&nbsp;</span>'+
                            '</h3>'+
                        '</div>'+
                        '<p>Ask me anything.</p>'+
                    '</section>'+
                        ...
                        '<div class="inputArea">'+
                            '<div class="pm-bxform">' +
                                ...
                                '<button id="pm-bottomClick" type="submit" onclick="return false;">'+
                                    '<img src="${devUrl}/images/icon_send.png" id="graySend" class="img-responsive" style="display: block;">'+
                                '</button>'+
                                '<div class="uploadbox">' +
                                    '<label>' +
                                        '<div class="inputfile">' +
                                            '<img src="${devUrl}/images/attachment.png" class="img-responsive">' +
                    ...
                    '<section id="jubi-textInput" class="jubi-sec_newFooter footer-two" style="float:left;width:100%;">'+
                        ...
                        '<aside class="jubi-muteUnmuteVoice">'+
                            '<div id="jubi-unmuteVoice">'+
                                '<img src="${devUrl}/images/unmute.png">'+
                            '</div>'+
                            '<div id="jubi-muteVoice">'+
                                '<img src="${devUrl}/images/mute.png">'+
                            '</div>'+
                        '</aside>'+
                        ...
                        '<div class="voice-buttons" id="voice-buttons">'+
                            '<div class="voiceIcon" id="button-play-ws">'+
                                '<img src="${devUrl}/images/voice.png" class="img-fluid">'+
                            '</div>'+
                        ...
                        '<div class="datasendButtons">'+
                            '<div class="sendIcon" id="button-send">'+
                                '<button id="jubi-bottomClick" type="submit" onclick="return false;">'+
                                    '<img src="${devUrl}/images/icon_send.png" id="jubi-graySend" class="img-responsive" style="display: block;">'+
                                    '<img src="${devUrl}/images/iconRed_send.png" id="jubi-redSend" class="img-responsive" style="display: none;">'+
                                '</button>'+
        ...
        '<section class="pm-sec_show_option_on_start" id="pm-sec_show_option_on_start" style="display:block">'+         
            '<div class="chatProceed" id="chatProceed">'+
                '<div class="chatProceed-botimg">'+
                    '<img src="${devUrl}/images/parrot_loader.gif" class="img-responsive">'+
                '</div>'+
...
.jubi-msgReplyTime h5{text-align:right;font-size:10px;color:#636262;}
